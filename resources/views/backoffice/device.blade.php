    ...
    <div class="card-body">
        <table class="table table-bordered text-center align-middle">
            <thead class="bg-light">
                <tr>
                    <th style="background-color: #ffd8e0ff !important;">Admin</th>
                    <th style="background-color: #ffd8e0ff !important;">Device ID</th>
                    <th style="background-color: #ffd8e0ff !important;">Approval</th>
                    <th style="background-color: #ffd8e0ff !important;">Status</th>
                    <th style="background-color: #ffd8e0ff !important;">Terakhir Digunakan</th>
