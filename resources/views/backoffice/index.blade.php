...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
        <div class="d-flex gap-2 flex-grow-1">
            ...
            <select id="departmentFilter" class="form-select form-select-sm" style="max-width:170px;">
                ...
                <option value="{{ strtolower($dept->cname) }}" {{ request('dept') == strtolower($dept->cname) ? 'selected' : '' }}>
                    {{ $dept->cname }}
                </option>
                @endforeach
            </select>
            ...
            <div class="position-relative flex-grow-1">
                <input type="text" id="searchInput" class="form-control form-control-sm"
                    placeholder="Cari user (nama, email, cabang, role)..." value="{{ request('keyword') }}">
    ...
    @include('backoffice.component.master_deptlokasi')
...
@include('backoffice.modal.modal_tambah_deptlokasi')
