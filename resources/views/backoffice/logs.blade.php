    ...
    <table class="table table-bordered align-middle">
        <thead class="table-light text-center">
            <tr>
                <th>ID</th>
                <th>Waktu</th>
                <th style="max-width: 30px;">Lokasi</th>
                <th style="white-space: nowrap;">Wifi Kantor</th>
                <th>Alasan</th>
        ...
        <tbody>
            ...
            <tr class="text-center align-top">
                ...
                {{-- Wifi Kantor --}}
                <td>
                    @if (!empty($log->ciswifi))
                        <span class="badge bg-success text-white">{{ strtoupper($log->ciswifi) }}</span>
                    @else
                        -
                    @endif
                </td>
