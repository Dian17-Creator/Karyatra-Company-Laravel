<div class="modal fade" id="editContractModal{{ $contract->nid }}" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <form action="{{ route('schedule.contract.update', $contract->nid) }}" method="POST" style="width: 100%;">
            @csrf
            @method('PUT')
            <div class="modal-content border-0 shadow" style="border-radius: 15px; overflow: hidden;">
                <div class="modal-header text-white" style="background-color: #0f7643; border-bottom: none; border-top-left-radius: 14px; border-top-right-radius: 14px; padding: 18px 24px;">
                    <h5 class="modal-title" style="font-weight: 600; font-size: 1.2rem;">Edit Kontrak</h5>
                </div>
                <div class="modal-body" style="padding: 24px;">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="nterm" class="form-select-custom">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="ctermtype" class="form-select-custom">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="cstatus" class="form-select-custom">
                ...
                <div class="modal-footer d-flex justify-content-between w-100 gap-3" style="background-color: #eef1f4; border-top: none; padding: 18px 24px 22px 24px; border-bottom-left-radius: 14px; border-bottom-right-radius: 14px;">
                    ...
                    <button type="submit" class="btn-shift-submit flex-fill">Simpan Perubahan</button>
                </div>
            </div>
        </form>
    </div>
