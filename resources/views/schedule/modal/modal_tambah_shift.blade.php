...
<div class="modal fade" id="addShiftModal" tabindex="-1" aria-labelledby="addShiftModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <form action="{{ url('/schedule') }}" method="POST" style="width: 100%;">
            @csrf
            <div class="modal-content border-0 shadow" style="border-radius: 15px; overflow: hidden;">
                ...
                <div class="modal-header text-white" style="background-color: #0f7643; border-bottom: none; border-top-left-radius: 14px; border-top-right-radius: 14px; padding: 18px 24px;">
                    <h5 class="modal-title" id="addShiftModalLabel" style="font-weight: 600; font-size: 1.2rem;">
                        Tambah Shift Baru
                    </h5>
                </div>
                ...
                <div class="modal-body" style="padding: 24px;">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="ctype" id="shiftType" class="form-select-custom" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="cname" class="form-control-custom" placeholder="Masukkan nama shift..." required>
                    </div>
                    ...
                    <div id="flexiFields" class="d-none">
                        <div class="mb-3">
                            ...
                            <input type="text" name="ctotal" class="form-control-custom" min="1" max="24"
